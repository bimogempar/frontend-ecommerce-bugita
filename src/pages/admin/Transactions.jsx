...
export default function Transactions() {
    return (
        ...
        <div className='p-5 h-screen'>
            <h1 className='text-xl mb-3'>List Transactions</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:hidden">
                ...
                <div className='bg-white space-y-3 p-4 rounded-lg shadow'>
                    <div className='flex items-center space-x-2 text-sm'>
                        ...
                        <div className='text-sm font-medium text-black'>Toni</div>
                        <div className='text-gray-500'>07/08/2022</div>
                        <div className='p-1.5 text-xs font-medium uppercase tracking-wider text-gray-800 bg-ray-300 rounded-lg bg-opacity-50'>Canceled</div>
                    </div>
                    <div className='text-sm text-gray-700'>Sandal Jepit Swallow Hijau</div>
                    <div className='text-sm font-medium text-black'>
                        Rp 20000
