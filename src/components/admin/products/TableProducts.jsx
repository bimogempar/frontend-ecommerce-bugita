        ...
        <div>
            ...
            <div className="flex my-4 gap-x-3 justify-between align-items-center">
                ...
                <div className="flex bg-white p-2 w-2/5 xl:w-1/5 space-x-4 rounded-xl">
                    ...
                    <input className="bg-white w-full outline-none text-gray-500" type="text" placeholder="Search" onKeyUp={e => setSearch({ search: e.target.value })} />
                </div>
            </div>
                            ...
                            products.map((product, index) => {
                                return (
                                    <tr key={product.id} className='bg-white'>
                                        ...
                                        <td className='p-3 text-sm text-gray-700'>Rp. 200</td>
